...
MODEL                = twofourbit_adder_template
MODULES              = mbd_main.c clock_S32K1xx.c interrupt_manager.c lpit_driver.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = twofourbit_adder_template.mk
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\twofourbit_adder_template_mbd_rtw \
...
%.o : C:\Users\ecs\Documents\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\code\mbdtbx_s32k\blocks\gpio/%.c
	@echo ### "C:\Users\ecs\Documents\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\code\mbdtbx_s32k\blocks\gpio\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
