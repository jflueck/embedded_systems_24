                    ...
                    *rty_Out1, DW_fast_subsystem_T *localDW)
{
   ...
   *  Sum: '<S1>/Sum1'
   */
  *rty_Out1 = (rtu_Input - localDW->DiscreteTimeIntegrator2_DSTATE) * 3.75F -
    0.0075F * localDW->DiscreteTimeIntegrator3_DSTATE;
  ...
  localDW->DiscreteTimeIntegrator3_PREV_U = 13.8696251F * *rty_Out1;
}
