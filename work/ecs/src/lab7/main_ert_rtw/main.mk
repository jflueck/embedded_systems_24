...
## 
## Makefile     : main.mk
## Generated on : Wed Sep 18 10:29:28 2024
...
PRODUCT_NAME              = main
MAKEFILE                  = main.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020A~1
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020A~1/bin
...
COMPILER_COMMAND_FILE     = main_comp.rsp
CMD_FILE                  = main.rsp
...
%.obj : $(START_DIR)/main_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/main_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
