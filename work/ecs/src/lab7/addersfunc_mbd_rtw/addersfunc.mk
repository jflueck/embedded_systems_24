...
MODEL                = addersfunc
MODULES              = mbd_main.c clock_S32K1xx.c interrupt_manager.c lpit_driver.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c AdderFunction_wrapper.c
MAKEFILE             = addersfunc.mk
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\addersfunc_mbd_rtw \
